"""
Django settings for swimmatch project.
...
WSGI_APPLICATION = 'swimmatch.wsgi.application'
...
# 정적 파일 디렉토리 지정
STATICFILES_DIRS = [
    BASE_DIR / 'static',  # manage.py와 같은 레벨의 static 폴더
]
